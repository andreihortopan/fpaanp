...
export class BarChartView extends Component {
  ...
  handleResize = () => {
    this.setState({
      graphWidth: this.containerDiv.current.clientWidth - 2 * MENU_PADDING,
      graphHeight: this.containerDiv.current.clientHeight - 3 * MENU_PADDING
    });
  };
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {barChartData.length === 1 &&
          barChartCountyDomainArray != null &&
          barChartCountyLegislationArray != null &&
          barChartCountyYearArray != null && (
            <Tabs>
              <TabList>
              ...
              <TabPanel>
                <Tabs>
                  ...
                  <TabPanel>
                    <BarChart
                      width={this.state.graphWidth}
                      height={this.state.graphHeight - BAR_CHART_DOUBLE_DIFF}
                      data={barChartCountyDomainArray.slice()}
                      margin={{ top: 5, right: 0, left: 20, bottom: 5 }}
                    >
                      <CartesianGrid strokeDasharray="3 3" />
                      <XAxis dataKey="name" />
                ...
                {/* <BarChart width={this.state.width} height={this.state.graphHeight} data={barChartCountyDomainArray.slice()}
                                margin={{ top: 5, right: 0, left: 20, bottom: 5 }}>
                                <CartesianGrid strokeDasharray="3 3" />
                                <XAxis dataKey="name" />
                                <YAxis />
              ...
              <TabPanel>
                <Tabs>
                  ...
                  <TabPanel>
                    <BarChart
                      width={this.state.graphWidth}
                      height={this.state.graphHeight - BAR_CHART_DOUBLE_DIFF}
                      data={barChartCountyLegislationArray.slice()}
                      margin={{ top: 5, right: 0, left: 20, bottom: 5 }}
                    >
                      <CartesianGrid strokeDasharray="3 3" />
                      <XAxis dataKey="name" />
                ...
                {/* <BarChart width={this.state.width} height={this.state.graphHeight} data={barChartCountyLegislationArray.slice()}
                                margin={{ top: 5, right: 0, left: 20, bottom: 5 }}>
                                <CartesianGrid strokeDasharray="3 3" />
                                <XAxis dataKey="name" />
                                <YAxis />
              ...
              <TabPanel>
                <Tabs>
                  ...
                  <TabPanel>
                    <BarChart
                      width={this.state.graphWidth}
                      height={this.state.graphHeight - BAR_CHART_DOUBLE_DIFF}
                      data={barChartCountyYearArray.slice()}
                      margin={{ top: 5, right: 0, left: 20, bottom: 5 }}
                    >
                      <CartesianGrid strokeDasharray="3 3" />
                      <XAxis dataKey="name" />
                ...
                {/* <BarChart width={this.state.width} height={this.state.graphHeight} data={barChartCountyYearArray.slice()}
                                margin={{ top: 5, right: 0, left: 20, bottom: 5 }}>
                                <CartesianGrid strokeDasharray="3 3" />
                                <XAxis dataKey="name" />
                                <YAxis />
